...
const SOCIAL_BUZZ = [
  ...
  { handle: "@MSiT_GOV_PL", platform: "X", text: "Infrastruktura #Polska2038 wpisuje się w naszą strategię SportPL2030. Pilotaż w 50 Orlikach ruszył w Q1 2026. 🇵🇱", likes: "19K", reposts: "6K", color: "red", tag: "ministry", verified: true, badge: "Ministerstwo Sportu i Turystyki" },
  ...
  { handle: "@R_Lewandowski", platform: "X", text: "Jako zawodnik wiem, jak trudno jest zaistnieć bez systemu. #Polska2038 da szansę tysiącom dzieci, które nie mają dostępu do skautingu. Jestem z tym projektem. ⭐🇵🇱", likes: "112K", reposts: "29K", color: "gold", tag: "media", verified: true, badge: "Robert Lewandowski — Ambasador" },
