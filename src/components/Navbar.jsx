        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 border border-white/10 bg-white/[0.02] text-gray-400 hover:text-white hover:border-white/20 font-mono text-[13px] uppercase tracking-widest transition-all rounded-md"
            ...
            <Link
              to="/login"
              className="px-4 py-2 bg-brand-cyan text-brand-dark font-display font-bold text-[13px] uppercase tracking-widest hover:bg-cyan-300 transition-all whitespace-nowrap rounded-md"
            >
              {t?.nav?.panel ?? 'Panel'} →
            </Link>
          </div>
