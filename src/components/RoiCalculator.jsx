  ...
  return (
    <div className={`p-5 border ${c.border} ${c.bg}`}>
      <div className="flex items-center justify-between mb-3">
        ...
        <span className={`font-mono font-bold text-lg ${c.text}`}>
          {value.toLocaleString('pl-PL')} {config.unit}
        </span>
      </div>
      <input
        type="range"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-display font-bold text-white">
            Policz Sw\u00f3j{' '}
            <span className="text-brand-gold text-glow-gold">ROI</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="p-5 border border-brand-border bg-brand-dark/80 space-y-2">
              <div className="text-gray-500 text-xs font-mono uppercase tracking-widest mb-3">
                Struktura Koszt\u00f3w
              </div>
          ...
          >
            ...
            <motion.div
              ...
              className={`p-8 border-2 text-center ${
                results.roi > 200
                  ? 'border-brand-neon/60 bg-brand-neon/5 border-glow-neon'
                  : results.roi > 0
                  ? 'border-brand-gold/60 bg-brand-gold/5'
                  : 'border-brand-red/60 bg-brand-red/5'
              }`}
            >
              <div className="text-gray-400 text-xs font-mono uppercase tracking-widest mb-2">
                Projected ROI po {values.years} latach
              </div>
              <div
                className={`text-6xl font-display font-bold mb-2 ${
                  results.roi > 200
                    ? 'text-brand-neon text-glow-neon'
                    : results.roi > 0
                    ? 'text-brand-gold'
                    : 'text-brand-red'
                }`}
              ...
              <div className="text-gray-500 text-sm font-mono">
                Break-even: ~{results.breakEvenMonths} miesi\u0119cy
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                {
                  label: 'Talenty wykryte',
                  value: results.talentsFound.toLocaleString('pl-PL'),
                  unit: 'zawodnik\u00f3w',
                  color: 'neon',
                  icon: <Users size={16} />,
                },
                {
                  label: 'Warto\u015b\u0107 z transfer\u00f3w',
                  value: formatPLN(results.revenue),
                  unit: 'przych\u00f3d',
                  color: 'cyan',
                  icon: <TrendingUp size={16} />,
                },
                {
                  label: 'Oszcz\u0119dno\u015bci scouting',
                  value: formatPLN(results.scoutingSavings),
                  unit: 'vs. tradycyjny',
                  color: 'gold',
                  icon: <Calculator size={16} />,
                },
                {
                  label: '\u0141\u0105czna korzy\u015b\u0107',
                  value: formatPLN(results.totalBenefit),
                  unit: 'total benefit',
                  color: 'red',
