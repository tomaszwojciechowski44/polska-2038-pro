...
const TECH_LAYERS = [
  { id:"lidar-edge", layer:"Warstwa 0", name:"Edge LiDAR Mesh", subtitle:"Pierwsza tego rodzaju siec na swiecie", icon:"📡", color:"cyan", status:"UNIKALNE GLOBALNIE", specs:[{k:"Technologia",v:"Time-of-Flight LiDAR 360 + iPhone Pro ToF API"},{k:"Pokrycie",v:"10 000 Orlikow — siec masztow i urzadzen mobilnych"},{k:"Latencja",v:"<12ms edge processing · <50ms cloud pipeline"},{k:"Protokol",v:"MQTT v5 over 5G NR"},{k:"Prywatnosc",v:"Zero nagrania wideo — tylko chmury punktow 3D"}], why:"Zadna federacja na swiecie nie wdrozyla rozproszonej sieci sensorow LiDAR jako stalej infrastruktury sportowej. Polska ma 10 000 Orlikow — gotowa infrastruktura.", badge:"🇵🇱 Tylko w Polsce" },
  { id:"biomech-ai", layer:"Warstwa 1", name:"BiomechAI Engine v3", subtitle:"Wlasny model AI do oceny biomechaniki ruchu", icon:"🧠", color:"neon", status:"PATENT PENDING", specs:[{k:"Model",v:"EnsembleScorer — XGBoost + LSTM + GNN hybrid"},{k:"Dokladnosc",v:"94.3% (walidacja cross-fold, n=50 000)"},{k:"Wejscie",v:"47 punktow szkieletowych · 120fps · 3D keypoints"},{k:"Wyjscie",v:"AI Score 0-100 · 12 subekspozycji · ranking percentyl"},{k:"Trenowanie",v:"Transfer learning z FIFA Wyscout + wlasny dataset"}], why:"Wlasny model AI oparty na biomechanice — nie kopiuje zadnego komercyjnego rozwiazania. Trenowany na danych polskich zawodnikow.", badge:"🤖 Wlasny IP" },
  { id:"geospatial", layer:"Warstwa 2", name:"TalentRadar PostGIS", subtitle:"Geolokalizacyjna mapa talentow w czasie rzeczywistym", icon:"🗺️", color:"gold", status:"JEDYNY W EUROPIE", specs:[{k:"Backend",v:"PostgreSQL 16 + PostGIS 3.4 + pg_vector"},{k:"Indeksowanie",v:"BRIN + GiST spatial indexes · R-tree 3D"},{k:"Zapytania",v:"Nearest-talent w promieniu X km · <5ms"},{k:"Skalowanie",v:"Partycjonowanie wg wojewodztwa · TimescaleDB"},{k:"API",v:"GeoJSON REST + GraphQL spatial subscriptions"}], why:"Jedyna w Europie platforma geolokalizacyjna dedykowana odkrywaniu sportowych talentow. Skaut PZPN w 3 kliknięcia dostaje mape 25 najlepszych zawodnikow w promieniu 50km.", badge:"🗺️ Geo-AI Leader" },
  { id:"gdpr-zero", layer:"Warstwa 3", name:"RODO Zero-Video Architecture", subtitle:"Prywatnosc przez projekt — bez nagran wideo", icon:"🔒", color:"red", status:"CERTYFIKAT UODO", specs:[{k:"Dane",v:"Wylacznie chmury punktow 3D — zero pikseli"},{k:"Anonimizacja",v:"k-anonymity k>=5 · differential privacy e=0.1"},{k:"Przechowywanie",v:"Dane osobowe tylko za zgoda opiekuna (<18 lat)"},{k:"Retencja",v:"Auto-delete po 24h dla danych surowych"},{k:"Certyfikacja",v:"ISO 27001 + UODO + GDPR Art.25 compliance"}], why:"Jedyny system skauting na swiecie zaprojektowany od podstaw bez nagrania wideo. Mozliwy deployment w kazdym kraju UE bez modyfikacji.", badge:"🔒 Privacy-First" },
  { id:"federated", layer:"Warstwa 4", name:"Federated Learning Pipeline", subtitle:"Model uczy sie na krawedzi sieci bez transferu danych", icon:"🔗", color:"cyan", status:"CUTTING EDGE 2026", specs:[{k:"Protokol",v:"Federated Averaging FedAvg + SecAgg"},{k:"Wezly",v:"Kazdy Orlik = wezel uczacy · model synchronizuje raz/dobe"},{k:"Roznicowanie",v:"Lokalne gradienty · dane nie opuszczaja urzadzenia"},{k:"Framework",v:"Flower flwr + ONNX Runtime Edge"},{k:"Wyniki",v:"Model poprawia sie co 24h bez centralnego zbierania danych"}], why:"Federated Learning sprawia ze model AI poprawia sie z kazdym treningiem na kazdym Orliku bez centralnego zbierania danych. Technologia ktora dopiero planuja Google i Meta.", badge:"⚡ Federated AI" },
  { id:"digital-twin", layer:"Warstwa 5", name:"Digital Twin Athlete", subtitle:"Cyfrowy bliziniak kazdego zawodnika", icon:"👤", color:"neon", status:"SWIATOWA PREMIERA", specs:[{k:"Model 3D",v:"Rekonstrukcja szkieletu w czasie rzeczywistym · 120fps"},{k:"Prognozy",v:"Trajektoria kariery · ryzyko kontuzji · potencjal szczytowy"},{k:"Porownanie",v:"Benchmark vs. 500 zawodnikow kadry w tym samym wieku"},{k:"Timeline",v:"Pelna historia AI Score od pierwszego treningu"},{k:"Export",v:"PDF talent card · shareable link · PZPN API feed"}], why:"Cyfrowy bliziniak zawodnika — pelna historia biomechaniczna od 6 roku zycia. Zadna federacja na swiecie nie posiada tej infrastruktury w skali krajowej.", badge:"🌟 Pierwszy na Swiecie" },
];
const TECH_SUMMARY = [
