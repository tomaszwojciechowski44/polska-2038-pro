      ...
      <section className="py-12 bg-gray-950 border-t border-gray-800">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <motion.div {...fadeUp(0)}>
            ...
            <p className="mx-auto max-w-2xl text-left text-gray-400 text-[15px] leading-relaxed mb-4 text-pretty">
              ...
              of PZPN, any political party, or commercial interest.
              <span className="text-gray-500"> All materials may be freely used, modified, and implemented by any institution without crediting us.</span>
            </p>
            <div className="flex flex-wrap justify-center gap-3">
